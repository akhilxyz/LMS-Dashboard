...
const EditCourceModal = ({ isOpen, onClose, courseId, courseDetails, onCourseUpdated }) => {
  ...
  const formik = useFormik({
    initialValues: {
      ...
      requirements: courseDetails?.requirements || 'No Requirements',
  ...
  }, [isOpen, courseDetails, updateFlag]);
          ...
          <Form onSubmit={formik.handleSubmit} className='row'>
            ...
            <FormGroup className="mb-3">
              ...
              <FormControl
                ...
                id="requirements"
                name="requirements"
                value={formik.values.requirements ? formik.values.requirements:"No requirements" }
                onChange={formik.handleChange}
                onBlur={formik.handleBlur}
